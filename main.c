...
int main(void)
{
	...
	ret = printf("%0i, %0d, %0d, %0d, %0d, %0d, %0d, %0d", 8, -12, 123456789, 0, -12345678, 97, -2147483648, 2147483647);
	printf("\tret: %d\n", ret);
	ret = ft_printf("%0i, %0d, %0d, %0d, %0d, %0d, %0d, %0d", 8, -12, 123456789, 0, -12345678, 97, -2147483648, 2147483647);
	printf("\tret: %d\n", ret);
	printf("\n\n");
