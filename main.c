...
int main(void)
{
	...
	printf("|%--4i|\n", 123);
	ret = printf("%*i, %-4d, %-4d, %-4d, %-4d, %-4d, %-4d, %-4d", -4, 8, -12, 123456789, 0, -12345678, 97, -2147483648, 2147483647);
	printf("\tret: %d\n", ret);
	ret = ft_printf("%*i, %-4d, %-4d, %-4d, %-4d, %-4d, %-4d, %-4d", -4, 8, -12, 123456789, 0, -12345678, 97, -2147483648, 2147483647);
	printf("\tret: %d\n", ret);
	printf("\n\n");
